...
class Map_Obj():
    ...
    def set_cell_value(self, pos, value, str_map: bool = True):
    ...
    def set_start_pos_str_marker(self, start_pos, themap):
    ...
    def set_goal_pos_str_marker(self, goal_pos, themap):
